...
python join_select.py -m months/$1.txt -l \
 ...
 -c 0 1 2 3 4 > data_no_master_historic/data_no_master_historic.$2.csv

echo 'removing'
python remove.py -f data_no_master_historic/data_no_master_historic.$2.csv -o data_no_master_historic/data_no_master_historic.csv.$2.removed -c \
...
echo 'cleaning'
python clean.py -f data_no_master_historic/data_no_master_historic.csv.$2.removed -o data_no_master_historic/data_no_master_historic.csv.removed.$2.clean.mrent
